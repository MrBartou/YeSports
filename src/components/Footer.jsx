    ...
    return (
        <footer className="bg-white rounded-lg shadow dark:bg-gray-900 mt-4">
            <div className="w-full max-w-screen-xl mx-auto pt-4">
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400 hover:underline">© 2024 <a href="https://flowbite.com/">YeSport</a>. Tous droits réservés.</span>
            </div>
        </footer>
    )
}
